<div x-data="audioPlayer()" x-init="init()" class="rounded-full border border-black w-fit mx-auto overflow-hidden shadow relative p-1">
    <audio x-ref="audio" src="https://commondatastorage.googleapis.com/codeskulptor-assets/sounddogs/thrust.mp3"></audio>
    ...
    <div class="absolute top-0 left-0 w-full h-full bg-green-300 rounded-full -z-20" :style="{ width: `${progress}%` }" style='width:100%;'></div>
    <div class="absolute border-t border-black bottom-0 left-0 w-full h-2 bg-green-300 rounded-full cursor-pointer" @click="seek($event)"></div>
</div>

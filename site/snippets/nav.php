<nav class="relative p-4 z-50" x-data="navComponent()" @click.away="closeNav()">
  ...
  <div class="flex justify-between sticky top-2">
    ...
    <button @click="toggleNav"
            ...
            class="flex hidden items-center border-slate-950 border border-b text-sm font-medium uppercase pl-2 pr-1 py-1 rounded-full hover:bg-slate-950 hover:text-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-opacity-75 group">
      Navigation
